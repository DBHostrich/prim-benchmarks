#!/usr/bin/env python3
"""Summarize repeated RED collection-transfer costs by transport key."""
...
def analyze(
    ...
    for path in paths:
        ...
        for row in rows:
            ...
            baseline_groups[transport_key_without_phase(row)].append(sample)
...
def main() -> int:
    ...
    if not summaries:
        raise SystemExit("No dpu_transfer rows found")
